--[AB] Shana - Nietono no Shana Level 6
--Scripted by Raivost (Ravi)
local s,id=GetID()
function s.initial_effect(c)
    --(1) Frenzy -> Use 1 Essence - Give All Allied Monsters 1 ATK
...
function s.essence_counter_cost(c,tp)
	return c:IsFaceup() and c:IsCode(899900000) and c:IsCanRemoveCounter(tp,0x892,1,REASON_COST)
end
function s.frenzy_cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	tc:RemoveCounter(tp,0x892,1,REASON_COST)
end
